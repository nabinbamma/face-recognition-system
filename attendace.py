...
class Attandance:
    def __init__(self,root):
        ...
        # second image
        img1=Image.open(r"college_images\cg.jpg")
        img1=img1.resize((680, 130),Image.ANTIALIAS)
        self.photoimg1=ImageTk.PhotoImage(img1)

        f_lbl=Label(self.root,image=self.photoimg1)
        f_lbl.place(x=680,y=0,width=700,height=130)
        ...
        title_lbl=Label(bg_img,text="ATTENDANCE MANAGEMENT SYSTEM",font=("times new roman",18,"bold"),bg="green",fg="white")
        ...
        # left frame 
        Left_frame=LabelFrame(main_frame,bd=3,bg="white",relief=RIDGE,text="Students Attandance  Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=2,y=1,width=660,height=518)
        
        img_left=Image.open(r"college_images\st3.jpg")
        ...
        update_button=Button(btn_frame,text="Export csv ",command=self.exportCsv,width=17,font=("times new roman",12,"bold"),bg="blue",fg="white")
